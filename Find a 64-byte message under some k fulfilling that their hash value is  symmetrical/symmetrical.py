...
length_of_string = 64
origin_m = ''.join(random.SystemRandom().choice(string.ascii_letters + string.digits) for _ in range(length_of_string))
m = bytes(origin_m, encoding='utf-8')
h = bytes((
              "abcdefghhgfedcba" "Arbitrary value1.""Arbitrary value2.""Arbitrary value3.""Arbitrary value4.""Arbitrary value5.""Arbitrary value6.""Arbitrary value7."),
          encoding='utf-8')
print("目标密文对称为：abcdefghhgfedcba")
print("明文：", origin_m)
print("满足的key：")
MEOW(m, h)